...
```
    ...
    ##          <dbl> <lgl>        <chr>         <fct>        
    ##  1      0.139  TRUE         medicine      medicine     
    ##  2     -0.858  FALSE        nursing       nursing      
    ##  3     -2.55   FALSE        biostatistics biostatistics
    ##  4     -1.65   FALSE        medicine      medicine     
    ##  5      0.424  TRUE         medicine      medicine     
    ##  6      0.604  TRUE         biostatistics biostatistics
    ##  7     -0.790  FALSE        nursing       nursing      
    ##  8      1.12   TRUE         biostatistics biostatistics
    ##  9     -0.0690 FALSE        nursing       nursing      
    ## 10     -0.118  FALSE        medicine      medicine
...
The mean value of norm_sample is -0.3745799
